...
<script>
	function checkForm(){
		...
		if(username == null || username == ''){
			alert("用户名不能为空!");
			//这里必须要return false,这样才能在验证不通过时，表单不进行提交
			return false;
		}
	...
	function change(){
		...
		img1.src = "${pageContext.request.contextPath}/checkImg.action?date=" + new Date().getTime();
	}
</script>
</head>
<body>
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" title="点击更换验证码" onclick="change()">
										</span>

					...
					<tr>
						<th colspan="5">
							...
							<s:if test="#order.state == 1">
								未<a href="${pageContext.request.contextPath }/order_findByOid.action?oid=<s:property value="#order.oid"/>"><font color="red">付款</font></a>
							</s:if>
							...
							<td colspan="5">
								<div class="pagination">
									...
									<s:if test="pageBean.page != 1">
										...
										<a class="previousPage" href="${pageContext.request.contextPath}/order_findByUid.action?page=<s:property value="pageBean.page-1"/>">&nbsp;</a></span>
									</s:if>	

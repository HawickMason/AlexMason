	...
	<div class="pagination">
		<s:if test="cid != null">
			...
			<s:if test="pageBean.page != 1">
				...
				<a class="previousPage" href="${pageContext.request.contextPath}/product_findByCid.action?cid=<s:property value="cid"/>&page=<s:property value="pageBean.page-1"/>">&nbsp;</a></span>
			</s:if>	
		...
		<s:if test="csid != null">
			...
			<s:if test="pageBean.page != 1">
				...
				<a class="previousPage" href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid"/>&page=<s:property value="pageBean.page-1"/>">&nbsp;</a></span>
			</s:if>	

...
<div class="span10 last">
		<div class="topNav clearfix">
			<ul>
				...
				<s:else>
				<li id="headerUsername" class="headerLogin" style="display: list-item;">
					你好: <s:property value="#session.existUser.username"/> |
				</li> 
				<li id="headerMyOrders" class="headerLogin" style="display: list-item;">
					<a href="${pageContext.request.contextPath }/order_findByUid.action?page=1">我的订单</a>|
				</li>
				<li id="headerLogout" class="headerLogin" style="display: list-item;">
